...
class Config:
    ...
    SYMBOLS: List[str] = field(default_factory=lambda: json.loads(os.getenv("SYMBOLS", '''[
        ...
        "AVAX/USDT", "MATIC/USDT", "LINK/USDT", "ATOM/USDT", "NEAR/USDT", "ALGO/USDT",
        "FTM/USDT", "AAVE/USDT", "UNI/USDT", "SUSHI/USDT", "COMP/USDT", "MKR/USDT",
        "CRV/USDT", "1INCH/USDT", "YFI/USDT", "SNX/USDT", "BAL/USDT", "REN/USDT",
        "LTC/USDT", "BCH/USDT", "ETC/USDT", "XLM/USDT", "VET/USDT", "THETA/USDT",
        "FIL/USDT", "TRX/USDT", "EOS/USDT", "XTZ/USDT", "DASH/USDT", "ZEC/USDT",
        "MANA/USDT", "SAND/USDT", "AXS/USDT", "ENJ/USDT", "CHZ/USDT", "FLOW/USDT"
    ]''')))
